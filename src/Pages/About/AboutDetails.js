    ...
    return (
        <div className={classes.container}>
            ...
            <div className={classes.text}>
                <img src='https://prasadyash2411.github.io/ecom-website/img/Band%20Members.png' alt='Band.Image' />
                <p >Lorem ipsum carrots enhanced rebates. Excellent sayings of a
                    ...
                    duties of the debts receives the very great importance to us that these are
                    consequent to that question is answered, which was selected for the fault, it is
                    often one of us, however, have any! Moreover, this is often not at once take the
                    hardships of the life of harsh condemn, we are accusing him? Him whom something large
                    cisterns.
                </p>
            </div>
